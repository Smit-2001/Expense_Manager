...
def expenses():
    ...
    return render_template('expenses.html',expenses=expenses,total=total,t_business=t_business,t_entertainment=t_entertainment,t_other=t_other,t_food=t_food)
